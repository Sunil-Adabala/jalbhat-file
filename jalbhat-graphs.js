...
var Vol_dep_data = {
 labels: [String(new Date().getTime())],
 datasets: [
     {
         label: "Speed",
         fill: true,
         ...
         pointBorderWidth: 1,
         pointHoverRadius: 5,
         pointHoverBackgroundColor: "rgb(238,130,238)",
         pointHoverBorderColor: "rgba(220,220,220,1)",
         pointHoverBorderWidth: 2,
         pointRadius: 1,
         pointHitRadius: 10,
         data: [{x: new Date().getTime(),y: data.speed}],
         spanGaps: false,
     },
     {
         label: "Volume",
         ...
         borderDashOffset: 0.0,
         borderJoinStyle: 'miter',
         pointBorderColor: "rgb(218,112,214)",
         pointBackgroundColor: "#fff",
         pointBorderWidth: 1,
         pointHoverRadius: 5,
         pointHoverBackgroundColor: "rgb(218,112,214)",
         pointHoverBorderColor: "rgba(220,220,220,1)",
         pointHoverBorderWidth: 2,
         pointRadius: 1,
         pointHitRadius: 10,
         data: [{x: new Date().getTime(),y: data.vol}],
         spanGaps: false,
     }
 ]
};
  ...
  datasets: [
      {
          ...
          pointRadius: 1,
          pointHitRadius: 10,
          data: [{x: new Date().getTime(),y: data.ph}],
          spanGaps: false,
      }
  ]
};
   ...
   datasets: [
       {
           ...
           pointRadius: 1,
           pointHitRadius: 10,
           data: [{x: new Date().getTime(),y: data.turbidity}],
           spanGaps: false,
       }
   ]
};
    ...
    datasets: [
        {
            ...
            pointRadius: 1,
            pointHitRadius: 10,
            data: [{x: new Date().getTime(),y: data.temp}],
            spanGaps: false,
        }
    ]
};
